...
const CartPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
          <title>Carrito de Compras | Libreria</title> 
          <meta name="description" content="Revisa los productos que añadiste al carrito. Finaliza tu compra de forma segura y recibe un seguimiento de pedido." />
        </Helmet>
      
      <article className="max-w-3xl mx-auto p-10 h-auto">
        <h1 className="font-extrabold text-2xl md:text-4xl py-10 text-center font-title text-[#2a2a2a]">
          Carrito de Compras
        </h1>
        {cart.length === 0 ? (
          ...
          <div className="bg-white shadow-md rounded-lg p-4">
                ...
                return (
                  <li key={index} className="flex flex-col md:flex-row items-center justify-between p-4 border-b last:border-none">
                    ...
                    <button 
                      ...
                      aria-label={`Eliminar ${book.title} del carrito`}
                    >
                      Eliminar
                    </button>
                  </li>
            ...
            <div className="flex justify-end mt-4">
              <button 
                className="bg-[#ff8e3c] hover:bg-[#d37533] text-black px-6 py-2 rounded-md transition-colors"
