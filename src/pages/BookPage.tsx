...
const handleQuantityChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  return(
    <>
      <Helmet>
          <title>{book.title} por {book.author} | Librería</title>
          <meta name="description" content={`Comprar ${book.title}. Descubre la sinopsis, precio y stock disponible.`} />
          ...
          <div className="flex items-center gap-2">
            ...
            <label className="mr-2" htmlFor="quantity">
              ...
              >
                ...
                <button
                className="bg-[#ff8e3c] hover:bg-[#e67a2e] text-black py-2 px-4 rounded"
                onClick={handleAddToCart}
                aria-label="Añadir libro al carrito"
                >
                Agregar al carrito
              </button>
          </div>
